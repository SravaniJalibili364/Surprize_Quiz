...
second_input = input()          # Taking the first String
sec_len = len(second_input)     # checking the length of the first string
if(sec_len % 2 != 0):           # if length of the first string is odd or not
